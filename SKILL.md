---
name: vqnet2_api
description: PyVQNet/VQNet2.0 API 文档助手 - 量子机器学习编程专家。当用户需要"用 VQNET2.0 写量子 ML 代码、实现 VQC、混合量子经典模型、GPU 训练、分布式训练"等任务时，自动调用此 Skill。触发关键词: VQNet, pyvqnet, QTensor, QuantumLayer, 量子神经网络, 变分量子线路, 量子机器学习, QVC, VSQL, Quanvolution。
license: Apache License 2.0
---

# VQNet 2.0 分层 Skill 体系
...
### 5. QuantumLayer Skill (quantum_layer)
...
### 7. QML 分类器 Skill (qml_classifier)
...
### 8. Quanvolution Skill (qml_quanvolution)
...
### 10. 分布式训练 Skill (distributed)

**能力**: MPI 多进程训练、NCCL GPU 通信、多节点部署。

**关键 API**:
- `pyvqnet.distributed.init_process_group(backend='mpi')`
- `mpirun -np N python train.py`

**参考文件**: `references/distributed.md`

**要求**: 仅支持 Linux，需要安装 MPI 和 NCCL

---

### 11. 真机运行 Skill (real_chip)
...
**参考文件**: `references/quantum_llm.md`
...
| PyTorch Backend | `references/torch_api.md` |
...
**Version**: 2.0
**Source**: VQNET2.0-tutorial RST 官方文档
